...
public class MyMaze {
  ...
  private String[][] grid; // output grid
  ...
  public MyMaze(int xDimension, int yDimension) {
      ...
      grid = new String[gridDimensionX][gridDimensionY];
      init();
      generateMaze();
  }
  ...
  public void solve(int startX, int startY, int endX, int endY) {
      ...
      for (int i= 0; i< cells.length; i++ ) {
          for (int j = 0; j < cells[0].length; j++) {
              ...
              cells[i][j].travelled = 0;
              cells[i][j].projectedDist = -1;
          }
      }
  ...
  public void updateGrid() {
      String backChar = "+", cellChar = " ", pathChar = "0";
      // fill background
